...
/* package datatypes-0.1.0.0 */
#ifndef VERSION_datatypes
#define VERSION_datatypes "0.1.0.0"
#endif /* VERSION_datatypes */
#ifndef MIN_VERSION_datatypes
#define MIN_VERSION_datatypes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_datatypes */
...
#define CURRENT_COMPONENT_ID "datatypes-0.1.0.0-inplace-datatypes"
