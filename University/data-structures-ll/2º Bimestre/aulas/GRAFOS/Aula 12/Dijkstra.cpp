...
/*
Problema 2
Dado o programa Dijkstra.c, implementar uma versão que calcule a distância entre as cidades de FW e 
Porto Alegre, considerando as rotas em azul e cinza, mostradas no mapa abaixo. O programa deve também 
