...
main() {
	Arv* a1= cria(1,inicializa(),inicializa()); /* sub-�rvore com '2'*/ //filho de 2, � tem folha adiciona NULL a esquerda e direita.
	Arv* a2= cria(2,inicializa(), a1); /* sub-�rvore com '1'*/ //a1 indica que j� est� ocupado
	Arv* a3= cria(3,inicializa(),inicializa()); /* sub-�rvore com 'e'*/ // folha, n tem filho, inicializa do dois lados
	Arv* a4= cria(4,inicializa(),inicializa()); /* sub-�rvore com 'f'*/ // verifica se � NULL, se for insere, sen�o indica que j� est� ocupado
	Arv* a5= cria(5,a3,a4); /* sub-�rvore com 'c'*/ // a5 � pai de a3(3) e a4(4)
	Arv* a = cria(6,a2,a5 ); /* �rvore com raiz 'a'*/ // RAIZ aponta para B e C
	imprime(a);
	puts("");
	imprime_alt(a);
	...
	// int busca (Arv* a, char c);
	printf("\nint busca (Arv* a, char c) %d", busca (a, 'a')); // existe a na �rvore?
